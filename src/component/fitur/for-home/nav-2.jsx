        ...
        <div className="flex">
            ...
            <div className="flex group relative">
                ...
                <div className={`flex-col absolute w-[120px] sm:w-[280px] h-auto text-[#ffff] font-[500px] font-[Lato] top-[20px] sm:top-[35px] right-[6px] sm:right-[12px]  bg-[#181A1C] ${ !open ? "hidden" : "flex"}`} >
                    <a className="flex flex-row justify-start text-[10px] sm:text-[25px]  box-border py-[8px] px-[12px] sm:py-[16px] sm:px-[24px] hover:text-[#3254FF] hover:transition duration-400 " href="/profile"><img className="w-[16px] sm:w-[28px] h-auto mr-[5px] sm:mr-[10px] object-contain" src={Acount} alt="" />Profil Saya</a>
                    <a className="flex flex-row justify-start text-[10px] sm:text-[25px]  box-border py-[8px] px-[12px] sm:py-[16px] sm:px-[24px] hover:text-[#3254FF] hover:transition duration-400 " href="/premium"><img className="w-[16px] sm:w-[28px] h-auto mr-[5px] sm:mr-[10px] object-contain" src={Star} alt="" />Ubah Premium</a>
