...
function Cover (props) {
    return (
        <div className="m-auto w-[306px] xl:w-[529px] h-auto bg-[#181A1CD6] rounded-xl xl:rounded-2xl flex flex-col items-center">
            ...
            <h3 className="font-[Lato] text-[#fff] text-[18px] xl:text-[32px] font-[700px] leading-[25.2px] xl:leading-[32px] mt-[20px] xl:mt-[37px]">{props.nama}</h3>
            ...
            <form className="mt-[20px] xl:mt-[37px] w-[306px] xl:w-[529px]" onSubmit={props.onSubmit} action="" >
